...
const Home = () => {
    return (
        <div className="max-w-[600px] mx-auto relative z-30 text-center px-4" >
            <h1 className="text-5xl md:text-[80px] text-center header-main-text font-medium bg-clip-text leading-[60px]  md:leading-[90px] mt-[150px]">A new way to edit your video</h1>

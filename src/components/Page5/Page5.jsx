    ...
    return (
        <div className="max-w-5xl mx-auto px-5 pb-10 relative z-40 h-full flex flex-col  gap-5">
            <div className='flex-grow flex justify-center items-center'>
                ...
                <div className="flex flex-col mt-36 lg:mt-16 lg:flex-row gap-7">
                    <div className='w-full lg:w-[75%]'>
                        <div className='w-full bg-white rounded-xl bg-opacity-20  px-6 py-4'>
                            ...
                            <div className='grid grid-cols-5 mt-4 mb-6 gap-3 lg:gap-9'>
                                ...
                                <div className='flex relative   rounded-xl bg-opacity-25 w-full items-center justify-center'>
                                    <h1 className='text-lg font-medium'>00:22</h1>
                                </div>
            ...
            <div className='flex gap-4 items-center '>
                <div className='flex-grow flex items-center'>
                    <div className='bg-white p-4 rounded-full bg-opacity-20'>
                        <img src={img4} className='w-[25px] h-[25px]' alt="" />
                    </div>

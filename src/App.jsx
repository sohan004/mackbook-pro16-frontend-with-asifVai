...
const App = () => {
  return (
    <div style={{ background: 'linear-gradient(0deg, rgba(69,8,74,1) 0%, rgba(1,1,1,1) 100%)' }} className="h-screen  overflow-hidden overflow-y-auto w-full text-white relative">
